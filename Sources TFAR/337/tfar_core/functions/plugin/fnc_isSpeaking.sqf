...
if !(_this getVariable ["A3PL_CurrentNameTFAR",""] isEqualTo "") then
{
    _name = _this getVariable ["A3PL_CurrentNameTFAR",""];
};

private _splitResult = ("task_force_radio_pipe" callExtension format ["IS_SPEAKING	%1", (_this getVariable ["TFAR_unitName", _name])]) splitString "";
