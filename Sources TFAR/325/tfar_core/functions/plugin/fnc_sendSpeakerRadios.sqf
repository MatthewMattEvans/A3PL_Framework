...
if((TFAR_currentUnit distance a3pl_prison_cour) <= 36) then {
	private _pos = getPosASL a3pl_prison_cour;
    private _frequencies = [format ["%1%2", 150, "_bluefor"]];
    _speakerRadios pushBack (["a3pl_prison_cour"/*radio_id*/,_frequencies joinString "|",""/*nickname*/,_pos/*pos*/,10/*volume*/, "no"/*vehicle*/] joinString TF_new_line);
};

if((TFAR_currentUnit distance a3pl_prison_couloir) <= 25) then {
	private _pos = getPosASL a3pl_prison_couloir;
	private _frequencies = [format ["%1%2", 151, "_bluefor"]];
	_speakerRadios pushBack (["a3pl_prison_couloir"/*radio_id*/,_frequencies joinString "|",""/*nickname*/,_pos/*pos*/,10/*volume*/, "no"/*vehicle*/] joinString TF_new_line);
};

if((TFAR_currentUnit distance a3pl_circuit_hp) <= 70) then {
	private _pos = getPosASL a3pl_circuit_hp;
	private _frequencies = [format ["%1%2", 1616, "_bluefor"]];
	_speakerRadios pushBack (["a3pl_circuit_hp"/*radio_id*/,_frequencies joinString "|",""/*nickname*/,_pos/*pos*/,10/*volume*/, "no"/*vehicle*/] joinString TF_new_line);
};

if((TFAR_currentUnit distance a3pl_pompier_LP) <= 60) then {
	private _pos = getPosASL a3pl_pompier_LP;
	private _frequencies = [format ["%1%2", 1617, "_bluefor"]];
	_speakerRadios pushBack (["a3pl_pompier_LP"/*radio_id*/,_frequencies joinString "|",""/*nickname*/,_pos/*pos*/,10/*volume*/, "no"/*vehicle*/] joinString TF_new_line);
};
...
} forEach [a3pl_gendarmerie_LP_1,a3pl_gendarmerie_LP_2,a3pl_gendarmerie_LP_3,a3pl_gendarmerie_LP_4];
...
} forEach [a3pl_pref_LP_1,a3pl_pref_LP_2,a3pl_pref_LP_3,a3pl_pref_LP_4,a3pl_pref_LP_5,a3pl_pref_SZ_1,a3pl_pref_SZ_2,a3pl_pref_SZ_3,a3pl_pref_SZ_4,a3pl_pref_airport,a3pl_pref_LC_1,a3pl_pref_LC_2];
