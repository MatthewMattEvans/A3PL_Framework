...
["TFAR","Radio Aérienne",["Radio Aérienne","Touche pour parler sur la radio aérienne."],{call A3PL_Phone_onAirRadioPressed},{call A3PL_Phone_onAirRadioReleased},[34, TF_tangent_lr_modifiers],false] call cba_fnc_addKeybind;

["TFAR","Megaphone",["Megaphone","Touche pour parler dans un megaphone"],{[] call A3PL_Phone_onMegaphonePressed},{[] call A3PL_Phone_onMegaphoneReleased},[16, TF_tangent_sw_modifiers],false] call cba_fnc_addKeybind;

["TFAR","SWTransmit",["Transmission standard","Touche pour parler sur un canal radio standard"],{call TFAR_fnc_onSwTangentPressed},{call TFAR_fnc_onSwTangentReleased},[18, TF_tangent_sw_modifiers],false] call cba_fnc_addKeybind;

["TFAR","SWTransmitAdditional",["Transmission Global","Touche pour parler sur un canal radio Global (Gendarmerie/Pompier)"],{call TFAR_fnc_onAdditionalSwTangentPressed},{call TFAR_fnc_onAdditionalSwTangentReleased},[20, TF_tangent_additional_sw_modifiers],false] call cba_fnc_addKeybind;

["TFAR","ChangeSpeakingVolume", ["Volume de voix", "Touche pour changer la portée de la voix (basse, normal, forte)"], {call TFAR_fnc_onSpeakVolumeChangePressed}, {true}, [TF_speak_volume_scancode, TF_speak_volume_modifiers], false] call cba_fnc_addKeybind;
