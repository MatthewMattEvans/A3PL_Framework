				...
				class Variables
				{
					grid_TFAR_Volume[]=
					{
						
						{
							...
							"(4 * (2 * (((safezoneW / safezoneH) min 1.2) / 50)))",
							"(4 * (2 * (((safezoneW / safezoneH) min 1.2) / 50)))"
						},
			...
			class TFAR_attributes
			{
				...
				class Attributes
				{
					...
					class TFAR_VehicleIDOverride
					{
						...
						expression="if !(_value isEqualTo '') then {_this setVariable ['TFAR_vehicleIDOverride',_value,true]};";
						typeName="STRING";
						validate="none";
					...
					class TFAR_defaultIntercomSlot
					{
						...
						expression="diag_log ['defaultIntercomSlot',_value]; if (_value != -2) then {_this setVariable ['TFAR_defaultIntercomSlot',_value,true]};";
						typeName="NUMBER";
						validate="number";
						condition="objectVehicle";
						defaultValue="-2";
