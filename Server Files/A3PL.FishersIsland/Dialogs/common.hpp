...
class RscCheckListBox: RscListBox
{
	class ListScrollBar
	{
		color[] = {0.7, 0.7, 0.7, 1};
...
class A3FL_RscButtonMenu : RscShortcutButton {
    idc = -1;
    type = 16;
    style = "0x02 + 0xC0";
    default = 0;
...
class A3FL_RscControlsGroupNoScrollbars : RscControlsGroup {
