class A3PL_SonyP_Dialog {
	idd = 38999;
	name= "A3PL_SonyP_Dialog";
	...
	class controls {
		...
		class SonyCentral : RscPicture {
			idc = 39120;
			text = "\A3PL_Common\GUI\newphone\SonyP\Sony_Central.paa";
			x = 0.200937 * safezoneW + safezoneX;
			y = 0.027 * safezoneH + safezoneY;
			w = 0.587812 * safezoneW;
			h = 1 * safezoneH;
		...
		class SonyMessagesLb : RscListBox {
			...
			font = "HelveticaLTLight";
			sizeEx = 0.035;
			onLBSelChanged = "[] call A3PL_Phone_lbChangedSmsSonyP;";
			x = 0.267708 * safezoneW + safezoneX;
		...
		class SonyStations : RscPicture {
			idc = 45161;
			text = "\A3PL_Common\GUI\newphone\SonyP\Sony_Stations.paa";
			x = 0.200937 * safezoneW + safezoneX;
			y = 0.027 * safezoneH + safezoneY;
			w = 0.587812 * safezoneW;
			h = 1 * safezoneH;
		...
		{
			idc = 45176;
			text = "\A3PL_Common\GUI\newphone\SonyP\Sony_Twitter.paa";
			x = 0.200937 * safezoneW + safezoneX;
			y = 0.027 * safezoneH + safezoneY;
			w = 0.587812 * safezoneW;
			h = 1 * safezoneH;
		...
		class HomeBtn : RscButtonEmpty {
			idc = 39000;
			text = "";
			onButtonClick = "uiNamespace setVariable ['sonyp',0]; [] call A3PL_Phone_menuSonyP;";
