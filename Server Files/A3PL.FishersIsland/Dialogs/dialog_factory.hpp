...
class Dialog_Factory
{
	...
	class controls
	{
		...
		{
			idc = 1100;
			text = "STR_UI_Factory_FactoryType";
			x = 0.217578 * safezoneW + safezoneX;
			y = 0.0118055 * safezoneH + safezoneY;
		...
		class progress_crafting: RscProgress
		{
			idc = 1105;
			style = "16 + 512";
			x = 0.79375 * safezoneW + safezoneX;
			y = 0.81875 * safezoneH + safezoneY;
		...
		class button_craft: RscButtonEmpty
		{
			...
			y = 0.952778 * safezoneH + safezoneY;
			w = 0.149531 * safezoneW;
			h = 0.044 * safezoneH;
			action = "call A3PL_Factory_Craft";
		};
		class list_recipes: RscListbox
		{
			idc = 1500;
			x = 0.0378902 * safezoneW + safezoneX;
			y = 0.079167 * safezoneH + safezoneY;
			w = 0.165 * safezoneW;
			h = 0.352 * safezoneH;
		...
		{
			idc = 1501;
			x = 0.0386722 * safezoneW + safezoneX;
			y = 0.618055 * safezoneH + safezoneY;
			w = 0.165 * safezoneW;
			h = 0.352 * safezoneH;
			sizeEx = 0.02 * safezoneH;
		};
		class list_storage: RscListbox
		{
			...
			y = 0.0756944 * safezoneH + safezoneY;
			w = 0.165 * safezoneW;
			h = 0.187 * safezoneH;
		...
		{
			idc = 1103;
			text = "STR_UI_Factory_ItemInfo";
			x = 0.0363282 * safezoneW + safezoneX;
			y = 0.451389 * safezoneH + safezoneY;
			w = 0.170156 * safezoneW;
			h = 0.022 * safezoneH;
			sizeEx = 0.016 * safezoneH;
		};
		class struc_status: RscStructuredText
		{
			idc = 1104;
			text = "";
			x = 0.793359 * safezoneW + safezoneX;
		...
		{
			idc = 1602;
			x = 0.987578 * safezoneW + safezoneX;
			y = 0.0041665 * safezoneH + safezoneY;
		...
		{
			idc = 1503;
			x = 0.79625 * safezoneW + safezoneX;
			y = 0.419778 * safezoneH + safezoneY;
			w = 0.165 * safezoneW;
			h = 0.187 * safezoneH;
			sizeEx = 0.016 * safezoneH;
		};
		...
		{
			idc = 1601;
			x = 0.804297 * safezoneW + safezoneX;
			y = 0.621528 * safezoneH + safezoneY;
			w = 0.149531 * safezoneW;
			h = 0.044 * safezoneH;
			action = "call A3PL_Factory_Add";
		};
		class button_moveToInventory: RscButtonEmpty
		{
			idc = 1603;
			x = 0.803124 * safezoneW + safezoneX;
			y = 0.277084 * safezoneH + safezoneY;
			w = 0.149531 * safezoneW;
			h = 0.044 * safezoneH;
			action = "call A3PL_Factory_Collect";
		};
		class search_recipes: RscEdit
		{
			idc = 1405;
			style = "16 + 512";
			x = 0.0351566 * safezoneW + safezoneX;
		...
		{
			idc = -1;
			x = 0.194531 * safezoneW + safezoneX;
			y = 0.481945 * safezoneH + safezoneY;
		...
		class craft_amount: RscEdit
		{
			...
			text = "1";
			style = "16 + 512";
			x = 0.794141 * safezoneW + safezoneX;
			y = 0.729861 * safezoneH + safezoneY;
		...
		class edit_amount: RscEdit
		{
			...
			text = "1";
			style = "16 + 512";
			x = 0.887891 * safezoneW + safezoneX;
			y = 0.729861 * safezoneH + safezoneY;
			w = 0.0773437 * safezoneW;
			h = 0.022 * safezoneH;
		};
